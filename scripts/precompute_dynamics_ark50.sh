...
#SBATCH --time=4:00:00
#SBATCH -A sk035
#SBATCH --output=./logs/out/out_precompute_dynamics_seq365.log
#SBATCH --error=./logs/err/err_precompute_dynamics_seq365.log
...
python3 ${IONO_REPO:-/path/to/ionosphere_diffusion}/precompute_dynamics_scores.py \
    ...
    --cache-path ${IONO_DATA_ROOT:-/path/to/data_root}/dynamics_scores_val_all_seq365.json \
    --split valid \
    --sequence-length 365 \
    --cartesian-transform \
