...
#SBATCH --time=4:00:00
#SBATCH -A sk035
#SBATCH --output=/capstor/scratch/cscs/framunno/logs/out/out_precompute_dynamics_seq36_new.log
#SBATCH --error=/capstor/scratch/cscs/framunno/logs/err/err_precompute_dynamics_seq36_new.log
...
python3 /users/framunno/projects/ionosphere_diffusion/precompute_dynamics_scores.py \
    ...
    --cache-path /capstor/scratch/cscs/framunno/dynamics_scores_val_all_seq36.json \
    --split valid \
    --sequence-length 36 \
    --cartesian-transform \
