...
#SBATCH --job-name="overfit_log10"
#SBATCH --error=./logs/err/err_overfit_15step_v4_cartesian_log10.log
#SBATCH --out=./logs/out/out_overfit_15step_v4_cartesian_log10.log
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G

# Configuration for log10 preprocessing test
SEQUENCE_LENGTH=30
PREDICT_STEPS=15
...
BATCH_SIZE=1
DIR_NAME="cond_forecasting_15frames_overfit_15step_v4_cartesian_log10"
CONDITIONING_LENGTH=$((SEQUENCE_LENGTH - PREDICT_STEPS))
WANDB_RUN_NAME="iono_forecast_cond${CONDITIONING_LENGTH}_pred${PREDICT_STEPS}_bs${BATCH_SIZE}_overfit_v4_cartesian_log10"

# New preprocessing settings
NORM_TYPE="ionosphere_preprocess"  # Use new SDO-style preprocessing
