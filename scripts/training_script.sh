...
#SBATCH -A sk035
#SBATCH --output=/users/framunno/logs/out/out_overfit_15step_v4_cartesian_coordinates_transformer.log
#SBATCH --error=/users/framunno/logs/err/err_overfit_15step_v4_cartesian_coordinates_transformer.log
...
export BATCH_SIZE=1
export DIR_NAME="ViT_forecast_15frames_overfit_absolute_max_cscs_debug_multinode"
CONDITIONING_LENGTH=$((SEQUENCE_LENGTH - PREDICT_STEPS))
export WANDB_RUN_NAME="ViT_forecast_cond${CONDITIONING_LENGTH}_pred${PREDICT_STEPS}_bs${BATCH_SIZE}_absolute_max_cscs_debug_multinode"
