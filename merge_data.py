...
params_file = "./data/ionosphere/params.csv"
solar_wind_file = "./data/ionosphere/combined_f1m_m1m_2024.csv"
...
output_path = "./data/ionosphere/merged_params_solar_wind_v2.csv"
